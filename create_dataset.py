...
def main():
    ...
    # # ❌ Original — expects a file path
    # bddl_file_name = f["data"].attrs["bddl_file_name"]

    # ✅ Replace with — reconstruct from content
    import tempfile
    bddl_content = f["data"].attrs["bddl_file_content"]
    fd, bddl_file_name = tempfile.mkstemp(suffix=".bddl", prefix="libero_rank_")
    os.close(fd)
    with open(bddl_file_name, "w") as tmp:
